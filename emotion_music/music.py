...
st.markdown(
    ...
    .custom-header {
        color: #006400;  /* Change this to your desired header color */
    ...
    /* Change the background color of text input fields */
    .stTextInput > div > div > input {
        background-color: white;  /* Change this to your desired background color */
    }

    /* Change the label color for text input fields */
    .stTextInput label {
    ...
    div.stButton > button {
        ...
        color: white;              /* Button text (label) color */
...
st.markdown('<div class="custom-header">Emotion Based Music Recommender</div>', unsafe_allow_html=True)
